...
public class PhotoTabLayout extends Fragment {
    ...
    private static int pageSize = PPUtils.getAppContext().getResources().getStringArray(R.array.photo_id).length;
    private String categoryId[] = PPUtils.getAppContext().getResources().getStringArray(R.array.photo_id);
    private String categoryName[] = PPUtils.getAppContext().getResources().getStringArray(R.array.photo_name);
