...
import com.netease.pineapple.base.BasePagerAdapter;
...
public class VideoTabLayout extends Fragment {
    ...
    private static int pageSize = PPUtils.getAppContext().getResources().getStringArray(R.array.mobile_video_id).length;
    private String categoryId[] = PPUtils.getAppContext().getResources().getStringArray(R.array.mobile_video_id);
    private String categoryName[] = PPUtils.getAppContext().getResources().getStringArray(R.array.mobile_video_name);
