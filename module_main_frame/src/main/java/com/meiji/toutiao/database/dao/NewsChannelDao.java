...
//        String categoryId[] = PPUtils.getAppContext().getResources().getStringArray(R.array.mobile_news_id);
//        String categoryName[] = PPUtils.getAppContext().getResources().getStringArray(R.array.mobile_news_name);
